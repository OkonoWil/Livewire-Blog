    ...
    <header class="navbar navbar-expand-md d-print-none" >
        <div class="container-xl">
            ...
            <div class="navbar-nav flex-row order-md-last">
                ...
                @auth()
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                                <span class="avatar avatar-sm" style="background-image: url({{Vite::asset('resources/static/avatars/000m.jpg')}})"></span>
                ...
                @guest()
                        <div class="nav-item dropdown md:tw-hidden">
                            <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
            ...
            <div class="navbar">
                <div class="container-xl">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link" href="{{route('posts.index')}}" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="false" >
                        ...
                        <li class="nav-item ">
                            <a class="nav-link" href="{{route('users.index')}}" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="false" >
